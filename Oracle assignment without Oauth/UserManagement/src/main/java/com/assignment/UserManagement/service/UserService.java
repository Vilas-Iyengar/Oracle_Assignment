...
public class UserService {
    ...
    public boolean authenticate(AuthUser authUser) {
        User user = userRepository.findByName(authUser.username()).orElseThrow(() -> new UserNotFoundException("User does not exists"));
        return authUser.password().equals(user.getPassword()) ? true : false;
    }
